...
public class SpaceAuditorIntent implements Intent<RelationshipResolution>
{
	public final SpaceIntent spaceIntent;
	public final CfUserIntent userIntent;
	private RelationshipResolution resolution;

	public SpaceAuditorIntent(SpaceIntent space, CfUserIntent user)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		SpaceAuditorIntent other = (SpaceAuditorIntent) obj;
		if (spaceIntent == null)
		{
	...
	{
		return "SpaceAuditorIntent [spaceIntent=" + spaceIntent
