...
public class OrgAuditorIntent implements Intent<RelationshipResolution>
{
	public final OrgIntent orgIntent;
	public final CfUserIntent userIntent;
	private RelationshipResolution resolution;

	public OrgAuditorIntent(OrgIntent org, CfUserIntent user)
	{
		this.orgIntent = org;
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		OrgAuditorIntent other = (OrgAuditorIntent) obj;
		if (orgIntent == null)
		{
	...
	{
		return "OrgAuditorIntent [orgIntent=" + orgIntent + ", userIntent="
				+ userIntent + "]";
	}
}
